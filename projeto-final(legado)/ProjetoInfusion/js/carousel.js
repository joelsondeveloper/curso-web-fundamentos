function Carousel(config) {
    ...
    typeof config.itens === "string"
      ? document.querySelectorAll(config.itens)
      : config.itens;

    this.btnPrev =
    typeof config.btnPrev === "string"
      ? document.querySelector(config.btnPrev)
      : config.btnPrev;

    this.btnNext =
    typeof config.btnNext === "string"
      ? document.querySelector(config.btnNext)
      : config.btnNext;
    ...
    function init() {
        ...
        Array.prototype.forEach.call(_show, function(item) {
